...
* @see https://v0.dev/t/QolpN4vFp8I
            ...
            <div className="space-y-2">
              ...
              <div className="grid gap-2">
                <Link
                  ...
                  <Badge className="bg-gray-100 text-gray-900 dark:bg-gray-800 dark:text-gray-50">Draft</Badge>
                </Link>
                <Link
                  className="flex items-center justify-between rounded-md px-3 py-2 text-sm font-medium text-gray-500 transition-colors hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-gray-50"
                  href="#">
            ...
            <div className="space-y-2">
              ...
              <div className="grid gap-2">
                <Link
                  ...
                  <Badge
                    className="bg-green-100 text-green-900 dark:bg-green-800 dark:text-green-50">Published</Badge>
                </Link>
                <Link
                  className="flex items-center justify-between rounded-md px-3 py-2 text-sm font-medium text-gray-500 transition-colors hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-gray-50"
                  href="#">
